...
#sounds
mixer.music.load(r"D:\game\python_game-main\game_space\background.wav")
mixer.music.play(-1)
#title
pygame.display.set_caption("In the space")
icon = pygame.image.load(r"D:\game\python_game-main\game_space\001-startup.png")
pygame.display.set_icon(icon)
#playerg
playerimg =pygame.image.load(r"D:\game\python_game-main\game_space\001-spaceship.png")
playerx =450
playery =650
playerx_change=0
playery_change=0
...
#missile
missimg =pygame.image.load(r"D:\game\python_game-main\game_space\002-bullet.png")
missx =1000
missy =1000
missx_change =0
missy_change =0
...
def shoot_out(missx,missy,enemyx,enemyy):
    ...
    if distance <30:
        ...
        return False
#enemy
enemyimg =pygame.image.load(r"D:\game\python_game-main\game_space\001-rock.png")
...
disenemy =pygame.image.load(r"D:\game\python_game-main\game_space\002-asteroids.png")
dis_enemyx =1000
dis_enemyy =1000
...
m_enemyimg= pygame.image.load(r"D:\game\python_game-main\game_space\001-space-ship.png")
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key ==pygame.K_UP:
                if miss_state == "ready":
                    ...
                    missile(missx,missy)
                    miss_state = "fire"
                    missile_sound = mixer.Sound(r"D:\game\python_game-main\game_space\laser.wav")
                    missile_sound.play()
